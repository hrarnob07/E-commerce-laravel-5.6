			  ...
			  <tbody>
				...
				<tr>
					...
					<td class="center">
						...
						@endif
						<a class="btn btn-info" href="{{URL::to('/edit_manufacture/'.$data->manufacture_id)}}">
							<i class="halflings-icon white edit"></i>  
						</a>
						<a class="btn btn-danger" href="{{URL::to('/delete_manufacture/'.$data->manufacture_id)}}" id="delete">
