	...
	<table class="table table-striped table-bordered bootstrap-datatable datatable">
	  ...
	  <tbody>
		...
		<tr>
			...
			<td class="center"><img src="{{url($data->slider_image)}}" style="height: 80px;width: 200px;"></td>
			...
			<td class="center">
				...
				@endif
				<a class="btn btn-info" href="{{URL::to('/edit_slider/'.$data->slider_id)}}">
					<i class="halflings-icon white edit"></i>  
				</a>
				<a class="btn btn-danger" href="{{URL::to('/delete_slider/'.$data->slider_id)}}" id="delete">
