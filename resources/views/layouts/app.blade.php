...
<link href="{{url('css/owl.theme.default.css')}}" rel="stylesheet">
<!--[if lt IE 9]>
...
<div id="slider-carousel" class="carousel slide" data-ride="carousel">
	...
	$all_publish_slider=DB::table('tbl__sliders')
...
<div class="item active">
	<?php }else{?>
		...
		<?php   }?>
		<div class="col-sm-4">
			<h1><span>E</span>-SHOPING</h1>
			<h2>HR ARNOB</h2>
			<p>New available product  </p>		
			<button type="button" class="btn btn-default get">Get it now</button>
		</div>
		<div class="col-sm-8">
			<img src="{{url($v_slider->slider_image)}}" class="girl img-responsive" alt="" />
					...
					<div class="brands_products"><!--brands_products-->
					 ...
					 foreach ($all_manufacture as $all_manu ) { ?>
					 	...
					 	<ul class="nav nav-pills nav-stacked">
								<li><a href="{{url('/manufacture_by_product/'.$all_manu->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$all_manu->manufacture_name}}</a></li>
